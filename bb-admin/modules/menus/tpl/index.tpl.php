...
<div id="dashboard-content-container" class="pure-u-1">
    <div id="dashboard-content">
        ...
        <div class="option-buttons">
            <a href="<?php echo module_uri('pages', 'new'); ?>" class="pure-button pure-button-primary"><?php echo __('admin.pages.btn_create'); ?></a>
            <a href="<?php echo module_uri('dashboard'); ?>" class="pure-button"><?php echo __('admin.pages.btn_back'); ?></a>
        </div>
